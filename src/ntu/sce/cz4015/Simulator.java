...
public class Simulator {
  private final int initiationEventCount = 10000;
  private final int warmUpPeriod = 2500;
  ...
  private void handleEvent(Event e){
    ...
    if (e instanceof CallInitiationEvent){
      ...
      // sb.append(e.id);
      // sb.append(',');
      // sb.append(this.blockedCallCount);
      // sb.append(',');
      // sb.append(this.droppedCallCount);
  ...
  public static void main(String[] args) {
    ...
    // System.out.println("AVE Blocked:" + totalBlockRate / rounds);
    // System.out.println("AVE Dropped:" + totalDropRate / rounds);
  }
